...
namespace FondOfSpryker\Client\NavisionCompany\Dependency\Client;
...
{
    /**
     * @var \FondOfSpryker\Client\NavisionCompany\Dependency\Client\NavisionCompanyToZedRequestClientBridge
     */
